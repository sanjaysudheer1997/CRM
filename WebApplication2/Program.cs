...
builder.Services
    .AddControllers()
    .AddApplicationPart(typeof(EmployeeController).Assembly) //Authentication
    .AddNewtonsoftJson();

//Add application identity services.
...
//builder.Services.Configure<WhatsAppServiceOptions>(configuration.GetSection("WhatsAppService"));
